...
public class Old_o_RelationFragment extends Fragment{
	...
	public static Old_o_RelationFragment NewInstance(int pos) {
		Old_o_RelationFragment d =new Old_o_RelationFragment();
	...
	public static Old_o_RelationFragment NewInstance() {
		Old_o_RelationFragment d =new Old_o_RelationFragment();
	...
	public void onActivityCreated(Bundle savedInstanceState){
        ...
        //gifts.clear();
        events = new Events();
        eventsAdapter = new Events_Adapter(getActivity(),null,events, imageLoader);
        ...
        */
        ...
        new DEFAULT_RELATIONSHIP_API().execute(re.getId());
	...
	public class DEFAULT_RELATIONSHIP_API extends AsyncTask<Object, Void, Boolean>{
		...
		protected Boolean doInBackground(Object... params) {
			...
			HttpPost request = new HttpPost(API.DASHBOARD);
			...
			try{
				...
				if(response.getStatusLine().getStatusCode() == 200){
					...
					if(success){
						...
						if(data!=null){
							JSONObject r = (JSONObject) data.get("relationship");
							...
							for(int i= 0; i < jsa.length(); i++){
								...
								//event.setType(e.optString("type"));
