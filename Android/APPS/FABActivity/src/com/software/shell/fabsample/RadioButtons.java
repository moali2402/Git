...
public class RadioButtons {
	...
	public static final Set<ColorsInfo> COLORS = new LinkedHashSet<ColorsInfo>();
	public static final Set<ColorsInfo> STROKE_COLORS = new LinkedHashSet<ColorsInfo>();
	public static final Set<AnimationInfo> ANIMATIONS = new LinkedHashSet<AnimationInfo>();
