...
public class ProfileImage extends ImageView {
    ...
    public void onDraw(Canvas canvas)
	{
		...
		{			
		    ...
		    bmp=  Bitmap.createBitmap(bmp, bmp.getWidth() > viewWidth ? (bmp.getWidth()/2)-(viewWidth/2) : 0 ,bmp.getHeight() > viewHeight ? (bmp.getHeight()/2)-(viewHeight/2) : 0,viewHeight, viewHeight);
		 ...
		 //   if(borderWidth != 0)
			canvas.drawCircle(getWidth()/2 + borderWidth, getHeight()/2, circleCenter, paintBorder);//-3
			canvas.drawCircle(getWidth()/2 + borderWidth, getHeight()/2,  circleCenter, paint);//-2
		  //  canvas.drawCircle(circleCenter/2 + borderWidth, circleCenter + borderWidth, circleCenter-borderWidth-4, paint);//-2
