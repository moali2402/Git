 ...
 *
 */
public class Tabbed_ImageView extends ImageView {
	 ...
	 * @param context
	 */
	public Tabbed_ImageView(Context context) {
		super(context);
	 ...
	 * @param attrs
	 */
	public Tabbed_ImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param defStyle
	 */
	public Tabbed_ImageView(Context context, AttributeSet attrs, int defStyle) {
