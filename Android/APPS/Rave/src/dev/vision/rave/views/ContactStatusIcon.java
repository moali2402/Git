...
public class ContactStatusIcon extends ImageView {
	...
	public ContactStatusIcon(Context context) {
		super(context);
		c=context;
	...
	public ContactStatusIcon(Context context, AttributeSet attrs) {
		super(context, attrs);
		c=context;
	...
	public ContactStatusIcon(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onDraw(Canvas canvas)
	{
		...
		{			
			...
			p.setColor(status);
			p.setAntiAlias(true);
			canvas.drawArc(new RectF(10, 10, 2*circleCenter + borderWidth, 2*circleCenter + borderWidth), -45, 180, true, p);
		    canvas.drawCircle(circleCenter + borderWidth, circleCenter + borderWidth, circleCenter-borderWidth-4, paint);//-2
		}		
	}
