 ...
 */
public class Main_CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
   ...
   // protected CameraPreviewSampleActivity mActivity;
    protected SampleCirclesDefault mActivity;
    ...
    public Main_CameraPreview(Activity activity, int cameraId, LayoutMode mode, ImageView v) {
    ...
    void Init(Activity activity, int cameraId, LayoutMode mode, ImageView v){
    	view = v;
        mActivity = (SampleCirclesDefault) activity;
    ...
    public void onClick() {
    	...
    	mActivity.rect.top= mActivity.rect.top-200;
    	mActivity.rect.bottom= mActivity.rect.bottom-200;

        mCamera.takePicture(null, null,
            new PhotoHandler(getContext(),mActivity.rect,view, mCameraId, Abc.user));
    }
