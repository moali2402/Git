...
public final class Constants {
	...
	public static String IP_ADDRESS = "http://api.dev-vision.co.uk";
	public static String FULL_PATH = IP_ADDRESS+":80/rave/";
	...
	{
	    String USER_ID =  getData(con, Constants.USER_ID, null);
	    String DISPLAY_NAME =  getData(con, Constants.DISPLAY_NAME, null);
	    String PROFILE_PIC =  getData(con, Constants.PROFILE_PIC, null);
	    String COVER_PIC =  getData(con, Constants.COVER_PIC, null);
	    String BIRTH_DATE =  getData(con, Constants.BIRTH_DATE, null);
	    String SEX =  getData(con, Constants.SEX, null);
	    String STATUS =  getData(con, Constants.STATUS, null);
	    String AGE =  getData(con, Constants.AGE, null);
	    String FOLLOWERS =  getData(con, Constants.FOLLOWERS, null);
	    String FOLLOWING =  getData(con, Constants.FOLLOWING, null);
	    String number =  getData(con, Constants.NUMBER, null);
	    if(USER_ID != null){
	        ...
	        if(PROFILE_PIC != null)
	        	user.setProfile_PicURL(PROFILE_PIC);
	        if(COVER_PIC != null)
		       	user.setCover_PicURL(COVER_PIC);
	        if(BIRTH_DATE != null)
	...
	public static final String[] IMAGES = new String[] {
			// Heavy images,
			"http://4.bp.blogspot.com/-27V6fE19wOQ/UX8f_V3KmUI/AAAAAAAAMcg/u0bz6lsmyVQ/s1600/hd+high+definition+wallpapers++8.jpg",
