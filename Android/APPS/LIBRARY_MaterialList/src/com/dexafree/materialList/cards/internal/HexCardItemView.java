...
public abstract class HexCardItemView<T extends SimpleCard> extends BaseCardItemView<T> {
    public HexCardItemView(Context context) {
        super(context);
    }

    public HexCardItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public HexCardItemView(Context context, AttributeSet attrs, int defStyle) {
