...
import com.flavienlaurent.notboringactionbar.HeaderGridView;
...
public class GridFragment extends ScrollTabHolderFragment implements OnScrollListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mListView = (HeaderGridView) v.findViewById(R.id.listView);
	...
	public void adjustScroll(int scrollHeight) {
		...
		//mListView.scrollListBy(scrollHeight);
		mListView.smoothScrollToPositionFromTop(1, scrollHeight,0);
		//mListView.scrollBy(0, scrollHeight);//(scrollHeight);
		//mListView.setSelection(1);//setSelectionFromTop(1, scrollHeight);
