...
import com.kmshack.newsstand.IconPagerAdapter;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			} else if (pager.getAdapter() instanceof IconPagerAdapter) {
		            addTab(i, pager.getAdapter().getPageTitle(i).toString(), ((IconPagerAdapter) pager.getAdapter()).getIconResId(i));		
		    }else{
