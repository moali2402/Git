...
public class CircularImageResizable extends ImageView {
	...
	public CircularImageResizable(Context context) {
		super(context);
		c=context;
	...
	public CircularImageResizable(Context context, AttributeSet attrs) {
		super(context, attrs);
		c=context;
		setup();
	}

	public CircularImageResizable(Context context, AttributeSet attrs, int defStyle) {
	...
	private void setup()
	{
		...
		if(!isInEditMode())
		setBorderColor(c.getResources().getColor(android.R.color.white));
