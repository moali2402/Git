...
public class CopyOfHeaderListView extends RelativeLayout {
    ...
    public CopyOfHeaderListView(Context context) {
        super(context);
        init(context);
    }

    public CopyOfHeaderListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    class HeaderListViewOnScrollListener implements AbsListView.OnScrollListener {
    ...
    public void setPagingEnabled(boolean enabled) {
    	mListView.setPagingEnabled(enabled);
	}
