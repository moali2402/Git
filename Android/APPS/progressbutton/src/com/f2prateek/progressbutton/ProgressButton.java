...
public class ProgressButton extends CompoundButton {
   ...
   */
  @SuppressLint("NewApi") private void init(Context context, AttributeSet attrs, int defStyle) {
    // Attribute initialization
    final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ProgressButton, defStyle,
        R.style.ProgressBut_Pin_Compat);
    ...
    int shadowDrawable =
        a.getResourceId(R.styleable.ProgressButton_shadow_Drawable, R.drawable.pin_progress_shadow);
  ...
  protected void onDraw(Canvas canvas) {
    ...
    iconDrawable = mProgress == mMax ? mPinnedDrawable : mUnpinnedDrawable;
