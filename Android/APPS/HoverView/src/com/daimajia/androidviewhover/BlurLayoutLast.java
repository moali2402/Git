...
@SuppressLint("NewApi") public class BlurLayoutLast extends RelativeLayout {
    ...
    private boolean enableBackgroundZoom = true;
    ...
    public BlurLayoutLast(Context context) {
        super(context);
    }

    public BlurLayoutLast(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BlurLayoutLast(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean isHover(){
        return getHoverStatus() == HOVER_STATUS.APPEARED || getHoverStatus() == HOVER_STATUS.APPEARING;
    }
    ...
    private void addBlurImage(){
        ...
        ImageView im = (ImageView) findViewById(getMyId(getContext(), "blurring"));
    ...
    public LayoutParams getFullParentSizeLayoutParams(){
        LayoutParams pm = (LayoutParams) mBlurImage.getLayoutParams();
